...
var _tableData = _interopRequireDefault(require("./db/tableData.json"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = {
  initTable: function initTable() {
    var tableWrapper = document.querySelector(_settings.select.table.tableContainer);
    var table = new _Table.default(_tableData.default, tableWrapper);
    table.init();
  },
  init: function init() {
    this.initTable();
...
app.init();
},{"./components/Table":"components/Table.js","./settings":"settings.js","./db/tableData.json":"db/tableData.json"}],"C:/Users/krzys/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/dynamic-table.e31bb0bc.js.map