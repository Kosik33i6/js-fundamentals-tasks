...
var Contact = /*#__PURE__*/function () {
  function Contact(name, surname, email, modificationDate, createDate, uuid) {
    _classCallCheck(this, Contact);

    var contactDataArray = [name, surname, email, modificationDate, createDate, uuid];
    contactDataArray.forEach(function (data) {
      var isArgumentsAreString = typeof data === 'string';
      if (!isArgumentsAreString) throw new Error('Arguments have to be a string');
      var isArgumentsHaveCorrectlyLength = data.length > 0;
  ...
  _createClass(Contact, [{
    ...
    value: function update(key, newValue) {
      var isCorrectKey = key === 'name' && key === 'surname' && key === 'email';
      if (isCorrectKey) throw new Error('Arguments key must be equal to "name" or "surname" or "email"');
      var isCorrectEmail = key === 'email' && !(0, _utils.default)(newValue);
      if (isCorrectEmail) throw new Error('Arguments key have to be a email');
      this[key] = newValue;
      this.modificationDate = (0, _moment.default)().format('MMMM Do YYYY, h:mm:ss a');
    }
  }, {
    key: "includesPhrase",
    value: function includesPhrase(searchingValue) {
      var isString = typeof searchingValue === 'string';
      if (!isString) throw new Error('Argument searchingValue have to be a string');
      var contact = "".concat(this.name, " ").concat(this.surname).toLowerCase().trim();
      var regExpForSearchingValue = new RegExp(searchingValue.toLowerCase().trim(), 'g');
...
exports.default = _default;
},{"moment":"../../node_modules/moment/moment.js","../utils":"utils.js"}],"components/withContactsHandling.js":[function(require,module,exports) {
"use strict";
...
var withContactsHandling = /*#__PURE__*/function () {
  function withContactsHandling(contactsList) {
    _classCallCheck(this, withContactsHandling);

    var isArray = Array.isArray(contactsList);
    if (!isArray) throw new Error('Arguments contactsList have to be an array');
    this.contactsList = contactsList;
  }

  _createClass(withContactsHandling, [{
    key: "addContact",
    value: function addContact(name, surname, email) {
      var isArgumentsHaveCorrectlylength = name.length >= 2 && surname.length >= 2 && email.length >= 4;
      if (!isArgumentsHaveCorrectlylength) throw new Error('Arguments are too short');
      var isArgumentHaveCorrectlyType = typeof name === 'string' && typeof surname === 'string' && typeof email === 'string';
      if (!isArgumentHaveCorrectlyType) throw new Error('Argumants name and surname have to be a string type');
      var isArgumentEmailValid = (0, _utils.default)(email);
      if (!isArgumentEmailValid) throw new Error('Argument email is not a email');
      var contactData = {
        modificationDate: (0, _moment.default)().format('MMMM Do YYYY, h:mm:ss a'),
        createDate: (0, _moment.default)().format('MMMM Do YYYY, h:mm:ss a'),
        uuid: (0, _uuid.v4)()
      };
      var contact = new _Contact.default(name, surname, email, contactData.modificationDate, contactData.createDate, contactData.uuid);
    ...
    key: "searchContact",
    value: function searchContact(searchingValue) {
      var isString = typeof searchingValue === 'string';
      if (!isString) throw new Error('Argument searchingValue have to be a string');
      var filteredContact = this.contactsList.filter(function (contact) {
    ...
    key: "updateContact",
    value: function updateContact(index, key, newValue) {
      this.indexValidator(index);
      var isCorrectKey = key === 'name' && key === 'surname' && key === 'email';
      if (isCorrectKey) throw new Error('Arguments key must be equal to "name" or "surname" or "email"');
      var isCorrectEmail = key === 'email' && !(0, _utils.default)(newValue);
    ...
    key: "indexValidator",
    value: function indexValidator(index) {
      var isIndexInteger = Number.isInteger(index);
      if (!isIndexInteger) throw new Error('Argument index have to be a integer');
      var isIndexNaN = Number.isNaN(index);
      if (isIndexNaN) throw new Error('Argument index cannot be a NaN');
      var IsIndexHaveCorrectlyValue = index >= 0 && index < this.contactsList.length;
      if (!IsIndexHaveCorrectlyValue) throw new Error('Argument index is too low or too high');
    }
  }]);

  return withContactsHandling;
}();

var _default = withContactsHandling;
exports.default = _default;
},{"moment":"../../node_modules/moment/moment.js","uuid":"../../node_modules/uuid/dist/esm-browser/index.js","../utils":"utils.js","./Contact":"components/Contact.js"}],"components/Group.js":[function(require,module,exports) {
"use strict";
...
var _withContactsHandling2 = _interopRequireDefault(require("./withContactsHandling"));
...
var Group = /*#__PURE__*/function (_withContactsHandling) {
  _inherits(Group, _withContactsHandling);
  ...
  function Group() {
    ...
    var contactsList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    ...
    var isString = typeof name === 'string' && typeof uuid === 'string';
    if (!isString) throw new Error('Arguments name and uuid have to be a string type');
    _this = _super.call(this, contactsList);
    _this.name = name;
    _this.uuid = uuid;
    return _this;
  }
  ...
  _createClass(Group, [{
    ...
    value: function rename(newName) {
      var isString = typeof newName === 'string';
      if (!isString) throw new Error('Argument name have to be a string');
      var isNameHaveCorrectlyLength = newName.length >= 2;
  ...
  return Group;
}(_withContactsHandling2.default);

var _default = Group;
exports.default = _default;
},{"./withContactsHandling":"components/withContactsHandling.js"}],"components/AddressBook.js":[function(require,module,exports) {
"use strict";
...
var AddressBook = /*#__PURE__*/function (_withContactsHandling) {
  _inherits(AddressBook, _withContactsHandling);
  ...
  function AddressBook() {
    ...
    var contactsList = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
    var groupList = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

    _classCallCheck(this, AddressBook);

    var isArray = Array.isArray(contactsList) && Array.isArray(groupList);
  ...
  _createClass(AddressBook, [{
    ...
    value: function addGroup(name) {
      ...
      if (!isString) throw new Error('Argument name have to be a string');
      var isNameHaveCorrectlyLength = name.length >= 2;
      if (!isNameHaveCorrectlyLength) throw new Error('Name length should be longer than two');
      var group = new _Group.default([], name, (0, _uuid.v4)());
    ...
    key: "renameGroup",
    value: function renameGroup(index, newName) {
      this.indexValidator(index);
      var isString = typeof newName === 'string';
      if (!isString) throw new Error('Argument name have to be a string');
      var isNameHaveCorrectlyLength = newName.length >= 2;
...
exports.default = _default;
},{"uuid":"../../node_modules/uuid/dist/esm-browser/index.js","./Group":"components/Group.js","./withContactsHandling":"components/withContactsHandling.js"}],"app.js":[function(require,module,exports) {
"use strict";

var _AddressBook = _interopRequireDefault(require("./components/AddressBook"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var addressBook = new _AddressBook.default();
addressBook.addContact('Krzysztof', 'Kos', 'krzysztof.kos33@gmail.com');
addressBook.addContact('Michał', 'Wegrzyn', 'michał.wegrzyn@gmail.com'); // addressBook.addContact('Marek', 'Abramowicz', 'michał.wegrzyn@gmail.com');
// addressBook.addContact('Ewelina', 'Plech', 'ewelina.plech@gmail.com');

addressBook.addGroup('Gr1');
addressBook.addGroup('Gr2');
addressBook.addGroup('Gr3'); // addressBook.removeGroup(0)

addressBook.renameGroup(1, 'Friends');
console.log(addressBook); // addressBook.removeContact(0);
// console.log(addressBook);
// console.log('Searching contact: ', addressBook.searchContact('M'));
},{"./components/AddressBook":"components/AddressBook.js"}],"C:/Users/krzys/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/krzys/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
